...
const SUMMARY =
  "Tổng hợp các tài liệu pháp lý của Vexim Trade: điều khoản dịch vụ, chính sách bảo mật và chính sách cookie. Tất cả tài liệu được cập nhật định kỳ và áp dụng cho toàn bộ khách hàng sử dụng nền tảng tại veximtrade.com."
...
const DOCS = [
  {
    ...
    description:
      "Thoả thuận giữa Vexim Trade và khách hàng về phạm vi dịch vụ, phí, tuân thủ FDA, xác thực SWIFT, trách nhiệm và giải quyết tranh chấp.",
    icon: FileText,
  },
  {
    href: "/legal/privacy",
