...
export function EngagementCard({ engagement: eng, clients, locale }: EngagementCardProps) {
    ...
    return (
      <>
        <Card
          ...
          className={cn(pending && "opacity-50 pointer-events-none")}
        >
...
function ConvertDialog({
  ...
  const handleConvert = async () => {
    if (roles.size === 0) {
      toast.error(t("Chọn ��t nhất 1 client", "Select at least 1 client"))
      return
    }
