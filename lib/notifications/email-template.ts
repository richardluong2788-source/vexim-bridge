...
const BOILERPLATE = {
  vi: {
    ...
    footer:
      "Bạn nhận email này vì đang sử dụng Vexim Trade. Bạn có thể điều chỉnh loại email nhận được hoặc ngừng nhận tại liên kết bên dưới.",
  ...
  en: {
    ...
    footer:
      "You are receiving this email because you use Vexim Trade. You can change which emails you get or unsubscribe using the link below.",
