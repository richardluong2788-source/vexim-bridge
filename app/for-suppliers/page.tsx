...
/**
 * Supplier acquisition page — the old homepage content preserved here.
 * Canonical is /for-suppliers so the buyer-first homepage at / can own
 * the root SEO.
 */
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: localizedAlternates("/for-suppliers", { bilingual: true, locale }),
    openGraph: {
      title,
      description,
      url: `${siteConfig.url}/for-suppliers`,
      type: "website",
