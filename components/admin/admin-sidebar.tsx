...
export function AdminSidebar({ profile, role, badgeCounts }: AdminSidebarProps) {
  ...
  const allItems: NavItem[] = [
    ...
    // Inbound public-form submissions (migration 082) — the only place a
    // landing-page enquiry exists besides someone's mailbox.
    { href: "/admin/marketing-leads",   label: locale === "vi" ? "Lead website" : "Website Leads", icon: Megaphone, cap: CAPS.MARKETING_LEADS_VIEW, badgeKey: "marketingLeads" },
